...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	(
		...
		FString("Increases Armo and Armor Penetration")
	);
	...
	*/
	...
	(
		...
		FString("Change to cut incoming damage in half")
	);
	...
	*/
	...
	(
		...
		FString("Frequency of a debuff's effect application")
	);
	...
	*/
	...
	(
		...
		FString("Attack Abilitiy Tag")
	);

	GameplayTags.Abilities_Summon = UGameplayTagsManager::Get().AddNativeGameplayTag
	(
		FName("Abilities.Summon"),
		FString("Summon Abilitiy Tag")
	);
	...
	*/
	...
	(
		...
		FString("Ability is eligible for unlock")
	);
