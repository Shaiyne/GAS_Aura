...
void AAuraEnemy::PossessedBy(AController* NewController)
{
	...
	AuraAIController->GetBlackboardComponent()->SetValueAsBool(FName("RangedAttacker"), CharacterClass == ECharacterClass::Ranger || CharacterClass == ECharacterClass::Elementalist);
}
...
void AAuraEnemy::BeginPlay()
{
	...
	if (HasAuthority())
	{
		UAuraAbilitySystemLibrary::GiveStartupAbilityes(this, AbilitySystemComponent);
	}
